...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.82.36:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: 'innovative-batch-pipeline-alerts', //update and provide your channel name
